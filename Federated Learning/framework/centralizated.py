...
def runWithoutFL():
    ...
    plt.plot(epochs, history.history['accuracy'], color=acc_color, linestyle=acc_linestyle, linewidth=acc_linewidth)
    plt.plot(epochs, history.history['loss'], color=loss_color, linestyle=loss_linestyle, linewidth=loss_linewidth)
